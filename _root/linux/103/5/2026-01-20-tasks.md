...
- `$SIGHUP` pode terminar, reiniciar ou fazer um processo reler suas informações
- `$SIGINT` interrompe um processo
- `$SIGQUIT` fecha ou para um processo
- `$SIGKILL` ou `$-9` mata abrubptamnente um processo 
- `$SIGTERM` solicita o termino de um processo (padrão) 
