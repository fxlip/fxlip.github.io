...
<div class="terminal-box">
  ...
  <div class="auto-term">
fxlip@www:~/Documentos/www/files/lpi1$ ps
    PID TTY          TIME CMD
  42840 pts/4    00:00:00 bash
 254137 pts/4    00:00:00 ps
fxlip@www:~/Documentos/www/files/lpi1$ ps -u
USER      PID %CPU %MEM    VSZ   RSS TTY    STAT START  TIME COMMAND
...
fxlip@www:~/Documentos/www/files/lpi1$ ps -ux | less
fxlip@www:~/Documentos/www/files/lpi1$ ps -uxa | less
fxlip@www:~/Documentos/www/files/lpi1$ ps -uxaf | less
fxlip@www:~/Documentos/www/files/lpi1$ ps -lxa | less
fxlip@www:~/Documentos/www/files/lpi1$ ps -wxa | less
fxlip@www:~/Documentos/www/files/lpi1$ 
  </div>
</div>
...
<div class="terminal-box">
  ...
  <div class="auto-term">
fxlip@www:~/Documentos/www/files/lpi1$ ps axu | head
USER         PID %CPU %MEM    VSZ   RSS TTY      STAT START   TIME COMMAND
...
root          10  0.0  0.0      0     0 ?        I<   10:04   0:00 [mm_percpu_wq]
root          11  0.0  0.0      0     0 ?        I    10:04   0:00 [rcu_tasks_kthread]
fxlip@www:~/Documentos/www/files/lpi1$ ps -ef | head
...
<div class="terminal-box">
  ...
  <div class="auto-term">
fxlip@www:~/Documentos/www/files/lpi1$ ps axu | grep photo
...
fxlip@www:~/Documentos/www/files/lpi1$ ps axu | grep init
root           1  0.0  0.0 168916 13476 ?        Ss   10:04   0:01 /sbin/init
fxlip     271182  0.0  0.0   6356  2316 pts/4    S+   18:39   0:00 grep init
fxlip@www:~/Documentos/www/files/lpi1$ ps u -C openrazer-daemon
USER         PID %CPU %MEM    VSZ   RSS TTY      STAT START   TIME COMMAND
...
<div class="terminal-box">
  ...
  <div class="auto-term">
fxlip@www:~/Documentos/www/files/lpi1$ pstree
systemd─┬─ModemManager───2*[{ModemManager}]
        ...
        ├─upowerd───2*[{upowerd}]
        └─wpa_supplicant
fxlip@www:~/Documentos/www/files/lpi1$ pstree -p
systemd(1)─┬─ModemManager(990)─┬─{ModemManager}(1012)
           ...
           │               └─{upowerd}(1715)
           └─wpa_supplicant(962)
fxlip@www:~/Documentos/www/files/lpi1$ pgrep bash
9370
14215
42840
fxlip@www:~/Documentos/www/files/lpi1$ ps axu | grep 42840
fxlip      42840  0.0  0.0  10080  6380 pts/4    Ss   11:05   0:00 bash
fxlip     281259  0.0  0.0   6356  2196 pts/4    S+   18:58   0:00 grep 42840
fxlip@www:~/Documentos/www/files/lpi1$ pgrep --help
...
<div class="terminal-box">
  ...
  <div class="auto-term">
fxlip@www:~/Documentos/www$ killall
...
fxlip@www:~/Documentos/www$ killall firefox
fxlip@www:~/Documentos/www$ killall httpd
fxlip@www:~/Documentos/www$ pkill firefox
fxlip@www:~/Documentos/www$ pkill -1 firefox -u fxlip
fxlip@www:~/Documentos/www$ pkill -h
