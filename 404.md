...
<div class="terminal-box" id="profile-terminal">
  <div class="terminal-header">
    ...
    <span class="terminal-title" id="terminal-title">fxlip.com</span>
  </div>
...
(function() {
  ...
  var pathSegment = location.pathname.slice(1).split('/')[0];
  ...
  function renderProfile(username, data, fingerprint) {
    ...
    document.getElementById('terminal-title').textContent = '@' + username + ' — fxlip.com';
  ...
  // -- MAIN --
  if (!pathSegment || BLACKLIST.has(pathSegment) || !/^[a-z0-9][a-z0-9-]{0,28}[a-z0-9]?$/.test(pathSegment) || !WORKER_URL) {
